...
private data class BeamStartCoordinateWithSourceSplitterNode(
    ...
    val sourceSplitterNode: DAGNode<Coordinate>,
)
...
object Part1 {
    fun solve(dayNumber: Int, fileName: String): Long {
        ...
        val startNode = DAGNode(value = startCoordinate)
        ...
        val alreadyProcessedSplitterLocations = mutableMapOf<Coordinate, DAGNode<Coordinate>>()
        ...
        val nodeCounter = NodeCountAggregator<Coordinate>()

        return rootNode.aggregate(nodeCounter::aggregate)
    }
}
